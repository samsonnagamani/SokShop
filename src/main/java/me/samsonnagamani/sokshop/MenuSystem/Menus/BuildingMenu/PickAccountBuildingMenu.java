...
public class PickAccountBuildingMenu extends Menu {
    private SokShop plugin = SokShop.getPlugin();

    public PickAccountBuildingMenu(PlayerMenuUtility playerMenuUtility) {
    ...
    public void handleMenu(InventoryClickEvent event) {
        // Player can only buy from this shop
        ...
        switch (itemClicked) {
            case PLAYER_HEAD:
                ...
                new BuildingMenu(playerMenuUtility).open();
                break;
            case DRAGON_HEAD:
